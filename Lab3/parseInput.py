...
to_decimal(8, 10, "truncated-out-10", load_numbers_many_lines("lab3-truncated-out-10.txt"))

print(RMSE(load_numbers("out.txt_scaled.txt"), load_numbers_many_lines("lab3-truncated-out-10-decimal.txt")))
